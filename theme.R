...
theme(
  ...
  axis.title.x = element_text(family = base_family, face="bold",  size = base_size, vjust = 0), 
  axis.title.y = element_text(family = base_family, face="bold", size = base_size, angle = 90, vjust = 0.5),
